      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-y-5 my-6 items-center justify-center">
        {projects.map((project, index) => {
          return (
            <div
              key={index}
              className="flex flex-col shadow-sm md:w-[343px] bg-gray-900 p-4 rounded"
            >
              <a
                href={project.photo}
                target="_blank"
              ...
              <div className="mt-5">
                <button className="btn transition-all duration-500 bg-[#a81f71] py-2 px-6 rounded text-white hover:bg-white hover:text-gray-900">
                  About me
                </button>
