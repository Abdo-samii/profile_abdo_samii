...
const About = () => {
  ...
  return (
    <div className="md:px-10 px-7 sm:-mt-24" id="about">
      <h1 className="text-gray-900 font-semibold text-3xl mt-5">About me:</h1>
      <p className="my-3 text-gray-900 md:w-2/3 leading-[2]">
        Hi, my name is Abdelrahman Samii, i am a Fullstack web developer, UI
      ...
      <div className="md:flex my-7 items-center">
        <div className="text-gray-900 text-8xl font-bold">5+</div>
        <p className="text-gray-900 text-2xl md:ml-5">
      ...
      <div className="flex flex-col md:flex-row ">
        {skills.map((skill, index) => (
          <div
            key={index}
            className="md:w-[256px] md:h-[254px] bg-gray-900 hover:bg-gray-600 flex flex-col items-baseline justify-end md:m-3 my-3 p-5 shadow-sm skills transition-all duration-500"
          >
