...
import icn from '../assets/iconf.png'
const Header = () => {
  let Links = [
    { name: "Home", link: "home" },
  ...
  return (
    <div className="w-full max-w-7xl">
      <div className="md:flex items-center justify-between py-4 md:px-10 px-7">
        ...
        <img 
         className="h-12 w-12"
        src={icn} href="/" /><span className="text-4xl text-gray-900">bdo Samii</span>
        </div>
        {/* Menu icon */}
        <div
          ...
          {Links.map((link) => (
            <li className="md:ml-8 md:my-0 my-7 font-semibold" key={link.name}>
              <Link
                ...
                smooth={true}
                spy={true}
                className="text-white hover:text-gray-900 duration-500"
              >
                {link.name}
              </Link>
            </li>
